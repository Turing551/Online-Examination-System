...
<title>ONILNE EXAMINATION SYSTEM</title>
...
<div class="col-md-10">
<a href="mailto:meeturfrndashok8@gmail" style="color:#000000">meeturfrndashok8@gmail</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/ashok.jpg" width=100 height=100 alt="Ashok_Knv" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ashok_Knv</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919502618424</h4>
		<h4 style="font-family:'typo' ">meeturfrndashok8@gmail.com</h4>
		<h4 style="font-family:'typo' ">Just a O(n) guy living in an O(log n) world.</h4></div>
		 </div>
		</p>
      </div>
